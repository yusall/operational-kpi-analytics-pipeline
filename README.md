...
The original dataset used during development is proprietary and is not included in this repository. A synthetic data generator is provided to replicate the schema and allow the pipeline to run.
...
It will now render properly with headings and bullets.

If it still doesn’t, tell me:
- Are you editing directly on GitHub or locally in VS Code?
- Is your file definitely named `README.md` (not `.txt`)?
